...
mkdir -p results/{base,osampl,full,rev,baseZ}
...
# Use the reversed data: Just R/L for now
...
for i in lefty righty ; do
    ...
    for j in A B C D E ; do
        ...
        for k in sv nn lda ; do
            ...
            for m in hemiconnectome hemiconnectome_Z ; do
...
# Second handedness division - not really using this anymore, it wasn't very
#   informative
