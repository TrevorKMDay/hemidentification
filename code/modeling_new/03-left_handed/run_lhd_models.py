...
hc0 = hc0[hc0["handedness"] == "lefty"]
hemiconnectome = ("hemiconnectome.LHD", hc0)
...
hchpZ0 = hchpZ0[hchpZ0["handedness"] == "lefty"]
hchpZ = ("hc.hpZ.LHD", hchpZ0)

lang_file = home / ".." / "inputs" / "hemiconnectome_language_hpZ.pickle"
with open(lang_file, "rb") as f:
    lang0 = pkl.load(f)

lang0 = lang0[lang0["handedness"] == "lefty"]
langhpZ = ("lang.hpZ.LHD", lang0)

# One hemi per

hc_1p = ("hc.1p.LHD", hc0[hc0["hemi"] == hc0["hemi_fold"]])
hchpZ_1p = ("hc.hpZ.1p.LHD", hchpZ0[hchpZ0["hemi"] == hchpZ0["hemi_fold"]])
langhpZ_1p = ("lang.hpZ.1p.LHD", lang0[lang0["hemi"] == lang0["hemi_fold"]])
